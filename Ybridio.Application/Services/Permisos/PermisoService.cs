...
/// </summary>
/// <remarks>
/// Runtime Concurrency Stabilization (ADR-026):
/// Usa SemaphoreSlim global para serializar evaluaciones de permisos y evitar
/// "A second operation was started on this context instance..." durante navegación
/// rápida, Document Surface activation, y pre-checks runtime concurrentes.
/// </remarks>
public sealed class PermisoService : IPermisoService
{
        ...
        Guid usuarioId, string clave, CancellationToken ct = default)
    {
        ...
        // Previene DbContext concurrency durante navegación/autorización simultánea.
        ...
        Guid usuarioId, CancellationToken ct = default)
    {
        ...
        try
        {
            // Doble check después del lock — otro thread pudo haber cacheado
