...
public class CuentaPorPagarConfiguration : IEntityTypeConfiguration<CuentaPorPagar>
{
    ...
    {
        builder.ToTable("CuentaPorPagar", "finanzas");
        builder.HasKey(e => e.Id);
        builder.Property(e => e.Id).UseIdentityColumn();

        builder.Property(e => e.NombreAcreedor).IsRequired().HasMaxLength(200);
        ...
        builder.HasIndex(e => new { e.EmpresaId, e.FechaVencimiento }).HasDatabaseName("IX_CuentaPorPagar_Empresa_Vencimiento");
    }
}
