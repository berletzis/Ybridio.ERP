...
public class OrdenTrabajoMaterialConfiguration : IEntityTypeConfiguration<OrdenTrabajoMaterial>
{
    ...
    {
        builder.ToTable("OrdenTrabajoMaterial", "ventas");
        ...
        builder.HasOne(e => e.OrdenTrabajo).WithMany(o => o.Materiales).HasForeignKey(e => e.OrdenTrabajoId).OnDelete(DeleteBehavior.Cascade);
