...
public class OrdenTrabajoConfiguration : IEntityTypeConfiguration<OrdenTrabajo>
{
    ...
    {
        builder.ToTable("OrdenTrabajo", "ventas");
        ...
        builder.Property(e => e.FechaCompromiso);
        ...
        builder.HasIndex(e => new { e.EmpresaId, e.Fecha }).HasDatabaseName("IX_OrdenTrabajo_Empresa_Fecha");
    }
}
