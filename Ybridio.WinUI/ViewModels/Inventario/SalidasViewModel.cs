...
/// Gestiona la CommandBar y el estado de la lista de movimientos de salida.
...
public sealed partial class SalidasViewModel : BaseContextViewModel
{
    ...
    private object? salidaSeleccionada;

    public ObservableCollection<object> Salidas { get; } = [];
    ...
    public async Task RefrescarAsync(CancellationToken ct = default)
    {
        ...
        var op = new GridOperationContext(
            ...
            Notes:            ["Datos pendientes — ISalidaService no implementado en Application layer"],
